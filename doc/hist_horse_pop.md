...
<img src="hist_horse_pop_files/figure-gfm/plot horses-1.png" alt="Fig 1. Historical Horses per Province" width="100%" />
<p class="caption">
Fig 1. Historical Horses per Province
</p>
...
<img src="hist_horse_pop_files/figure-gfm/plot province-1.png" alt="Fig 2. Horse Counts for: Alberta" width="100%" />
<p class="caption">
Fig 2. Horse Counts for: Alberta
</p>

</div>

In this plot, we see that the horse population in Alberta has declined
rapidly since the early 1900s.
