...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Fig 1. Historical Horses per Province", out.width="100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap = paste0("Fig 2. Horse Counts for: ", params$province), out.width = "100%"}
...
In this plot, we see that the horse population in `r params$province` has declined rapidly since the early 1900s.
